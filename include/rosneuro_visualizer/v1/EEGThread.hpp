#ifndef ROSNEURO_VISUALIZER_EEGTHREAD_HPP
#define ROSNEURO_VISUALIZER_EEGTHREAD_HPP
...
class EEGThread : public NeuroThread {

	Q_OBJECT

	public:
		EEGThread(Ui::NeuroVizPanel* ui, QObject* parent = nullptr);
		virtual ~EEGThread(void);
